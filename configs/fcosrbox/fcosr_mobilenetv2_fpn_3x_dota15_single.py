_base_ = ['./dataset/dota15_single.py', './schedules/3x_schedules.py']
...
model = dict(
    ...
    rbbox_head=dict(
        ...
        drop_positive_sample=dict(
            enable=True, mode='local', iou_threshold=0.6, keep_min=1),
        loss_cfg=dict(
...
log_level = 'INFO'
work_dir = 'work_dirs/DOTA15/FCOSR-S/FCOSR_mobilenetv2_fpn_3x_dota15_single'
