...
class MobileNetV2_N(BaseModule):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(MobileNetV2_N, self).__init__(init_cfg)
        ...
        if not set(out_indices).issubset(set(range(0, 7))):
            raise ValueError('out_indices must be a subset of range'
                             f'(0, 7). But received {out_indices}')
    ...
    def train(self, mode=True):
        ...
        frozen."""
        super(MobileNetV2_N, self).train(mode)
        self._freeze_stages()
